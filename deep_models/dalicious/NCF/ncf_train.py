...
from preprocessing import preprocessing, train_test_split, make_train_lists, make_test_lists
...
def train_ncf(db_path, order_path, num_ng_test, num_neg, embedding_size, 
    ...
    data['label'] = 1
    data, user2id, item2id, item_pool, num_users, num_items = preprocessing(data)
